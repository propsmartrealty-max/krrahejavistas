...
function buildWhatsAppMessage(pathname?: string | null): string {
  ...
  if (lower.includes('2-bhk') || lower.includes('2bhk')) {
    return 'Hi, I am interested in the 2 BHK Luxury Apartment at K Raheja Vistas Mahalunge. Please share details and pricing.';
  }
  if (lower.includes('4-bhk') || lower.includes('duplex') || lower.includes('penthouse')) {
    return 'Hi, I am interested in the premium configurations at K Raheja Vistas Mahalunge. Could you please connect me with your sales executive?';
  }
  if (lower.includes('nri')) {
    return 'Hi, I am an NRI interested in investing at K Raheja Vistas Mahalunge, Pune. Please share investment details and NRI purchase process.';
  }
  if (lower.includes('investment')) {
    return 'Hi, I am exploring K Raheja Vistas Mahalunge as an investment opportunity. Could you please share ROI, rental yield data and current pricing?';
  }
  
  // Default
  return 'Hi, I am interested in K Raheja Vistas Mahalunge. Please share project details, pricing and availability.';
}
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-transform duration-200">
        {/* Pulse ring */}
